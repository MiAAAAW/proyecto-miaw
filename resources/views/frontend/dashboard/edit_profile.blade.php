            ...
            @csrf
                ...
                <div class="media-body">
                    <div class="file-upload-wrap file-upload-wrap-2">
                        <input id="photo" type="file" name="photo" class="multi file-upload-input with-preview" multiple>
                ...
                <div class="input-box col-lg-6">
                    ...
                    <div class="form-group">
                        <input class="form-control form--control" type="text" name="name" id="name" value="{{$profileData->name}}">
                ...
                <div class="input-box col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <span class="fa-solid fa-house input-icon"></span>
                    </div>
                </div><!-- end input-box -->
