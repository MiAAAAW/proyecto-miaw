                ...
                <div class="chat-sidebar-header">
                    <div class="d-flex align-items-center">
                        <div class="chat-user-online">
                            <img src="{{!empty($profileData->photo)? url('upload/instructor_images/'.$profileData->photo):
url('upload/no_image.jpg')}}" width="45" height="45" class="rounded-circle" alt="" />
                        </div>
                            ...
                            <div class="chat-list">
                                <div class="list-group list-group-flush">
                                    <a href="javascript:;" class="list-group-item">
                                        <div class="d-flex">
                                            <div class="chat-user-online">
                                                <img src="{{!empty($question['user']['photo'])? url('upload/user_images/'.$question['user']['photo']):
url('upload/no_image.jpg')}}" width="42" height="42" class="rounded-circle" alt="" />
                                            </div>
                                            <div class="flex-grow-1 ms-2">
            ...
            <div class="chat-header d-flex align-items-center">
                ...
                <h4>{{$question['course']['course_name']}}</h4>
            ...
            <div class="chat-content">
                <div class="chat-content-leftside">
                    <div class="d-flex">
                        <img src="{{!empty($question['user']['photo'])? url('upload/user_images/'.$question['user']['photo']):
url('upload/no_image.jpg')}}" width="48" height="48" class="rounded-circle" alt="" />
                        <div class="flex-grow-1 ms-2">
                            <p class="mb-0 chat-time"><b>{{$question['subject']}}</b>,  {{\Carbon\Carbon::parse($question->created_at)->diffForHumans()}}</p>
