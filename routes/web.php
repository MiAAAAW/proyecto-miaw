...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(\App\Http\Controllers\Backend\QuestionController::class)->group(function(){
...
Route::middleware(['auth', 'roles:admin'])->group(function () {
    ...
    Route::controller(AdminController::class)->group(function(){
        ...
        Route::get('/admin/course/details/{id}', 'AdminCourseDetails')->name("admin_course_details");
    });
...
Route::get('/admin/login', [AdminController::class, 'AdminLogin'])->name('admin.login')->middleware(\App\Http\Middleware\RedirectIfAuthenticated::class);
...
Route::get('/instructor/login', [InstructorController::class, 'InstructorLogin'])->name('instructor.login')->middleware(\App\Http\Middleware\RedirectIfAuthenticated::class);
///Route for index
...
Route::controller(CartController::class)->group(function () {
    ...
    Route::post('/buy/data/store/{id}', "BuyCourse");
...
Route::post('/lectures/update-checkbox-state/{lectureId}', [\App\Http\Controllers\LectureController::class, 'updateCheckboxState']);
