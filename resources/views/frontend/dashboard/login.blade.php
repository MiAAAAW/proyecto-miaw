                            ...
                            <form method="post" class="pt-4" action="{{route('login')}}">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control form--control password-field" id="password" required autocomplete="current-password" type="password" name="password" placeholder="Password">
