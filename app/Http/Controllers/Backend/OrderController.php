...
class OrderController extends Controller
{
    ...
    public function InstructorAllOrder(){
        ...
        $id = Auth::user()->id;
        $latestOrdersItem = Order::where('instructor_id',$id)->select('payment_id',DB::raw('MAX(id) as max_id'))->groupBy('payment_id');
        $orderItem = Order::joinSub($latestOrdersItem,'latest_order',function($join){
