            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <a href="index.html">
                        ...
                        @else
                            <img src="{{ asset('default-logo.png') }}" alt="default footer logo" class="footer__logo">
                        @endif
                    </a>
                    ...
                    <ul class="social-icons social-icons-styled">
                        <li class="mr-1">
                            @if($setting && $setting->facebook)
                                <a href="{{ $setting->facebook }}" class="facebook-bg"><i class="la la-facebook"></i></a>
                            @else
                        ...
                        <li class="mr-1">
                            @if($setting && $setting->twitter)
                                <a href="{{ $setting->twitter }}" class="twitter-bg"><i class="la la-twitter"></i></a>
                            @else
...
{{--            <div class="row align-items-center">--}}
{{--                <div class="col-lg-6">--}}
{{--                    <p class="copy-desc">&copy; 2024 Aduca. All Rights Reserved. by Phong<a href=""></a></p>--}}
{{--                </div><!-- end col-lg-6 -->--}}
{{--                <div class="col-lg-6">--}}
{{--                    <div class="d-flex flex-wrap align-items-center justify-content-end">--}}
{{--                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">--}}
