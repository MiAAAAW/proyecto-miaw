                ...
                <div class="tab-pane fade show active" id="business" role="tabpanel" aria-labelledby="business-tab">
                    <div class="row">
                        @foreach ($courses as $course)
                            {{--                           --}}
                            <div class="col-lg-4 d-flex responsive-column-half">
                                    ...
                                    <div class="card-image">
                                        ...
                                        <div class="course-badge-labels">
                                            ...
                                            @endif
                                                ...
                                                @else
                                                    <div class="course-badge blue">-{{round($discount_percent)}}%</div>
                                                @endif
                                        </div>
                                    </div><!-- end card-image -->
                        ...
                        <div class="row">
                            ...
                            @forelse ($catwiseCourse as $course)
                                <div class="col-lg-4 responsive-column-half">
                                    <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_2{{$course->id}}">
                                        <div class="card-image">
    ...
    <div id="tooltip_content_1{{$item->id}}">
        <div class="card card-item">
            <div class="card-body">
                ...
                <h5 class="card-title pb-1"><a href="#">{{$item->course_name}}</a></h5>
...
@foreach( $courseData as  $item)
    <div class="tooltip_templates">
        <div id="tooltip_content_2{{$item->id}}">
            <div class="card card-item">
                <div class="card-body">
                    <p class="card-text pb-2">By <a href="#">{{$item['user']['name']}}</a></p>
                    <h5 class="card-title pb-1"><a href="#">{{$item->course_name}}</a></h5>
