                            ...
                            <div class="col-lg-6">
                                <div class="card card-item">
                                    <div class="card-image">
                                        <a href="{{ url('blog/details/'.$item->id) }}" class="d-block">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"><a href="{{ url('blog/details/'.$item->id) }}">{{ $item->post_title }}</a></h5>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center pt-3">
                                            <a href="{{ url('blog/details/'.$item->id) }}" class="btn theme-btn theme-btn-sm theme-btn-white">Read More <i class="la la-arrow-right icon ml-1"></i></a>
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($post as $dpost)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        <a href="{{ url('blog/details/'.$dpost->id) }}" class="media-img">
                                            <img class="mr-3" src="{{ asset($dpost->post_image) }}" alt="Related course image">
                                        </a>
                                        <div class="media-body">
                                            <h5 class="fs-15"><a href="{{ url('blog/details/'.$dpost->id) }}">{{ $dpost->post_title }}</a></h5>
