...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
            ...
            <h2 style="color: green; font-size: 26px;"><strong>E-learning shop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               E-learning Head Office
               Email:tangthieuphong888@gmail.com <br>
               Mob: 0938860238 <br>
               Phong 1207,Tang:#4 <br>
...
<div class="authority float-right mt-5">
    <p>-----------------------------------</p>
    <h5>Authority Signature: Tang Thieu Phong</h5>
</div>
</body>
</html>
