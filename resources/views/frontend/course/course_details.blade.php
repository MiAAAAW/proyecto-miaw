            ...
            <div class="col-lg-8 mr-auto">
                <div class="breadcrumb-content">
                    <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                        ...
                        <li><a href="#">{{ $course->category->category_name ?? 'No Category' }}</a></li>
                    ...
                    <div class="d-flex flex-wrap align-items-center pt-3">
                        ...
                        @endif
                            ...
                            @php
                                $reviewcount = App\Models\Review::where('course_id',$course->id)->where('status',0)->latest()->get();
                                $avarage = App\Models\Review::where('course_id',$course->id)->where('status',0)->avg('rating');
                    ...
                    <p class="pt-2 pb-1">Created by <a href="{{route('instructor.details',$course->user->id)}}"
                    ...
                    <div class="course-details-content-wrap pt-90px">
                            ...
                            <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                                ...
                                <div class="curriculum-duration fs-15">
                                    ...
                                    <span class="curriculum-total__hours"><strong
                                                class="text-black font-weight-semi-bold">Total hours: </strong>{{$course->duration}}</span>
                                </div>
                            </div>
                            @php
                            ...
                            <div class="instructor-wrap">
                                <div class="media media-card">
                                    <div class="instructor-img">
                                        <a href="{{route('instructor.details',$course->user->id)}}" class="media-img d-block">
                                            <img class="lazy" src="{{ (!empty($course->user->photo)) ? url('upload/instructor_images/'.$course->user->photo) : url('upload/no_image.jpg')}}"
                                                  alt="Avatar image">
                                        </a>
                                        <ul class="generic-list-item pt-3">
                                            ...
                                            <li><a href="{{route('instructor.details',$course->user->id)}}">View all Courses</a></li>
                                        </ul>
                        ...
                        <div class="course-overview-card pt-4">
                            ...
                            <div class="see-more-review-btn text-center">
                                <button type="button" class="btn theme-btn theme-btn-transparent">Load more reviews
                                </button>
                            </div>
                        </div><!-- end course-overview-card -->
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                @php
                                    ...
                                    $discount_percent = ($amount/$course->selling_price)*100;
                                @endphp
                                <div class="preview-course-feature-content pt-40px">
                                    <p class="d-flex align-items-center pb-2">
                                        ...
                                        @endif
                                        <span class="price-discount">{{ round($discount_percent) }}% off</span>
                                    </p>
                                    ...
                                    <div class="buy-course-btn-box">
                                        <button type="submit" class="btn theme-btn w-100 mb-2" onclick="addtoCart({{$course->id}},'{{$course->course_name}}', '{{$course->instructor_id}}', '{{$course->course_name_slug}}')" ><i
                                                    class="la la-shopping-cart fs-18 mr-1"></i> Add to cart
                                        </button>
                                        <button type="button" class="btn theme-btn w-100 theme-btn-white mb-2" onclick="buyCourse({{$course->id}},'{{$course->course_name}}', '{{$course->instructor_id}}', '{{$course->course_name_slug}}')"><i
                                                    class="la la-shopping-bag mr-1"></i> Buy this course
                                        </button>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item generic-list-item-flash">
                                    <li class="d-flex align-items-center justify-content-between"><span><i
                                                    class="la la-clock mr-2 text-color"></i>Duration</span> {{$course->duration}} hours
                                    </li>
                                    ...
                                    <div class="media-body">
                                        ...
                                        @if($relatedCourse->discount_price == NULL)
                                            <p class="text-black font-weight-semi-bold lh-18 fs-15">
                                               ${{$relatedCourse->selling_price}}</p>
                                        @else
                                            <p class="text-black font-weight-semi-bold lh-18 fs-15">${{$relatedCourse->discount_price}}
                                                <span class="before-price fs-14">${{$relatedCourse->selling_price}}</span></p>
                                        @endif
    ...
    <section class="related-course-area bg-gray pt-60px pb-60px">
        <div class="container">
            <div class="related-course-wrap">
                <h3 class="fs-28 font-weight-semi-bold pb-35px">More Courses by <a href="#" class="text-color hover-underline">{{ $course['user']['name'] }}</a></h3>
                <div class="view-more-carousel-2 owl-action-styled  align-items-stretch">
