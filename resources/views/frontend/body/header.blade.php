                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        <div class="theme-picker d-flex align-items-center">
                            <button class="theme-picker-btn dark-mode-btn" title="Dark mode" onclick="toggleReset()">
                                <svg id="moon" viewBox="0 0 24 24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
                                </svg>
                            </button>
                            <button class="theme-picker-btn light-mode-btn" title="Light mode" onclick="toggleReset()">
        ...
        <div class="container-fluid">
            <div class="main-menu-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="{{\Illuminate\Support\Facades\Auth::check() ? route('dashboard') : route('index')}}" class="logo">
        ...
        <ul class="generic-list-item off-canvas-menu-list pt-90px">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="#">list left sidebar <span class="ribbon ribbon-blue-bg">New</span></a></li>
                    <li><a href="#">list right sidebar <span class="ribbon ribbon-blue-bg">New</span></a></li>
